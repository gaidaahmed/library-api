...
class DeleteBookResponse(object):
    ...
    def __init__(self, status=None, message=None, _configuration=None):  # noqa: E501
        """DeleteBookResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def status(self):
        """Gets the status of this DeleteBookResponse.  # noqa: E501


        :return: The status of this DeleteBookResponse.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    @property
    def message(self):
        """Gets the message of this DeleteBookResponse.  # noqa: E501


        :return: The message of this DeleteBookResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DeleteBookResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteBookResponse):
            return False
